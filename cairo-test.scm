...
(sample-cairo "text-align-center"
		...
		(let ([utf8 "cairo"]
		  ...
		  (let ([x (- 128.0 (+ (/ (ftype-ref cairo-text-extents-t (width) extents) 2) (ftype-ref cairo-text-extents-t (x-bearing) extents)))]
			[y (- 128.0 (+ (/ (ftype-ref cairo-text-extents-t (height) extents) 2) (ftype-ref cairo-text-extents-t (y-bearing) extents)))])
		    (cairo-move-to cr x y)
...
(sample-cairo "text-extents"
		...
		(let ([utf8 "cairo"]
		 ...
		 (cairo-fill cr)
		 (cairo-move-to cr x y)
		 (cairo-rel-line-to cr 0 (- (ftype-ref cairo-text-extents-t (height) extents)))
		 (cairo-rel-line-to cr (ftype-ref cairo-text-extents-t (width) extents) 0)
		 (cairo-rel-line-to cr (ftype-ref cairo-text-extents-t (x-bearing) extents) (- (ftype-ref cairo-text-extents-t (y-bearing) extents)))
		 (cairo-stroke cr))))
